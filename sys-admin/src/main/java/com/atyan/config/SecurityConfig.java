...
import com.atyan.filter.JwtAuthenticationTokenFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    //注入我们在atyan-blog工程写的JwtAuthenticationTokenFilter过滤器
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        //把我们在atyan-blog工程写的JwtAuthenticationTokenFilter过滤器添加到Security的过滤器链中
