...
public class JwtAuthenticationTokenFilter extends OncePerRequestFilter {
    ...
    @Autowired
    //RedisCache是我们在atyan-framework工程写的工具类，用于操作redis
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        //JwtUtil是我们在atyan-framework工程写的工具类。解析获取的token，把原来的密文解析为原文
        Claims claims = null;
        try {
            ...
            e.printStackTrace();
            //报异常之后，把异常响应给前端，需要重新登录。ResponseResult、AppHttpCodeEnum、WebUtils是我们在atyan-framework工程写的类
